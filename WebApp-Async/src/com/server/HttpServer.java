...
/**
 * 
 * Simple Java non-blocking NIO HTTP server.
 *
 */
public class HttpServer implements Runnable {
    ...
    //Define a server socket channel, calling the Open() method to create a server socket channel
    ...
    protected HttpServer(InetSocketAddress address) throws IOException {
    	//Gets the server socket associated with this channel,and bind to a particular address
        server.socket().bind(address);
        //Adjust the channel blocking mode is set to false, the channel is in non-blocking mode
